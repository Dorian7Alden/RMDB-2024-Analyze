...
flowchart TB
    subgraph internal["内部节点 is leaf = false"]
        i_text["rid0 | key0 | rid1 | key1 | rid2 | key2 | rid3"]
    end

    subgraph leaf["叶节点 is leaf = true"]
        l_text["key0 : rid0 | key1 : rid1 | key2 : rid2"]
    end
...
> ```
>
> 这正是 mermaid 图中 `rid0 | key0 | rid1 | key1 | rid2 | key2 | rid3` 的含义：按顺序交替排列，n 个键对应 n+1 个孩子——**分隔关系**，不是配对关系。
>
