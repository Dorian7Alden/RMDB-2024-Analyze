...
flowchart TB
    ...
    sticky1["n 个键, n+1 个孩子指针<br/>孩子数 = 键数 + 1"] -.-> internal
    sticky2["n 个键, n 个记录 Rid<br/>键数 = Rid 数"] -.-> leaf

    style internal fill:#dbeafe,stroke:#3b82f6,color:#1e40af
    style leaf fill:#d1fae5,stroke:#10b981,color:#065f46
    style sticky1 fill:#fef3c7,stroke:#f59e0b,color:#92400e
    style sticky2 fill:#fef3c7,stroke:#f59e0b,color:#92400e
```
