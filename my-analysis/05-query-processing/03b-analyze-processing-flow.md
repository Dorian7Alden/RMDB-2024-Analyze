...
本页接续[上一节](./03a-analyze-data-structures.md)的数据结构，讲解 `do_analyze()` 如何处理各种 SQL 语句。
...
上一节：[03a-analyze-data-structures.md](./03a-analyze-data-structures.md) | 下一节：[04-optimizer-detail.md](./04-optimizer-detail.md)
